...
while fields.update_proc():
    ...
    if fields.scene != previous_scene:
        ...
        #     print('模式选择')
        #
        if fields.scene == 3 or fields.scene == 8:
            print('人物选择')
            time.sleep(1)
            keymgr.send_z()
            keymgr.send_z()
        ...
        while fields.check_scene() == 5 or fields.check_scene() == 13 or fields.check_scene() == 14:
            ...
            reward_p1 = frame['p1_damage'] - frame['p2_damage'] + 0.2*(frame['p1_spirit_damage'] - frame['p2_spirit_damage']) + frame['p1_damage_limit']

            reward_p2 = frame['p2_damage'] - frame['p1_damage'] + 0.2*(frame['p2_spirit_damage'] - frame['p1_spirit_damage']) + frame['p2_damage_limit']
            # print(ep_r_p2)
            ...
            print('time2:', end_time_2 - start_time)
            time.sleep(1 / 60)
